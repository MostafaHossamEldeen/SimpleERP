<%@ Page Title="إعداد الرواتب" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="hr_salaryprep.aspx.cs" Inherits="VanSales.HR.hr_salaryprep" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="../Scripts/App/Public/Messages.js"></script>
    <script src="../Scripts/App/HR/hr_salaryprep.js"></script>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="إعداد الرواتب" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div dir="rtl" style="text-align: center;">
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_Save" ClientInstanceName="btn_Save" runat="server" Height="20px" RenderMode="Secondary" Width="20px" ToolTip="حفظ" OnClick="btn_Save_Click">
                    <ClientSideEvents Click="function(s, e) {validate(s, e);}" />
                    <Image Height="20px" Url="~/img/icon/save.svg" Width="20px">
                    </Image>
                </dx:ASPxButton>

                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_addnew" ClientInstanceName="btn_addnew" runat="server" AutoPostBack="False" Height="20px" RenderMode="Secondary" Width="20px" ToolTip="جديد" OnClick="btn_addnew_Click">
                    <Image Height="20px" Url="~/img/icon/add-new.svg" Width="20px"></Image>
                </dx:ASPxButton>

                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete" ClientInstanceName="btn_delete" runat="server" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                    <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/HR/salaryprep_del', 'HF_sprepid') }" />
                    <Image Height="20px" Url="~/img/icon/delete.svg" Width="20px"></Image>
                </dx:ASPxButton>

                <button type="button" id="master" data-name="master" data-tablename="hr_salaryprep_sel_pop" data-displayfields="sprepno,sprepdate,monyrname,vochrid,branchname"
                    data-displayfieldshidden=""
                    data-displayfieldscaption="رقم الاعداد,التاريخ,الشهر/السنة,رقم القيد,الفرع"
                    data-bindcontrols="HF_sprepid;txt_sprepno;cmb_monyrid;cmb_branchid;txt_userprep;txt_vchrid;hf_postacc;txt_sprepnotes;txt_sprepdate"
                    data-bindfields="sprepid;sprepno;monyrid;branchid;userprep;vchrid;postacc;sprepnotes;sprepdate"
                    data-apiurl="/VanSalesService/items/FillPopup" data-pkfield="sprepid" onclick="createPopUp($(this),'popupModalsearch')" class="btn btn-sm btnsearchpopup">
                </button>

                <dx:ASPxButton ID="btn_prep" UseSubmitBehavior="false" runat="server" ClientInstanceName="btn_prep" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="إعداد الرواتب" OnClick="btn_prep_Click">
                    <Image Height="20px" Url="~/img/icon/calculator.svg" Width="20px"></Image>
                </dx:ASPxButton>
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_postacc" runat="server" ClientInstanceName="btn_postacc" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="ترحيل حسابات">
                    <ClientSideEvents Click="function(s,e){PostSalaryPrep(s,e)}" />
            ...
            <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" RightToLeft="True">
                ...
                <Items>
                    <dx:LayoutGroup ColCount="3" GroupBoxDecoration="None" Caption="">
                        <Items>
                            <dx:LayoutItem Caption="رقم الاعداد">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_sprepno" runat="server" ClientInstanceName="txt_sprepno" Font-Bold="True" Text="تلقائى">
                            ...
                            <dx:LayoutItem Caption="الشهر / السنة">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxComboBox ID="cmb_monyrid" runat="server" ClientInstanceName="cmb_monyrid" AutoPostBack="false">
                                        </dx:ASPxComboBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            ...
                            <dx:LayoutItem Caption="المستخدم">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_userprep" runat="server" Theme="MaterialCompact" ClientInstanceName="txt_userprep">
                                            <ClientSideEvents Init="function(s, e) {
	txt_userprep.GetInputElement().readOnly = true; 
}" />
                                        </dx:ASPxTextBox>
                            ...
                            <dx:LayoutItem Caption="التاريخ">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxDateEdit ID="txt_sprepdate" runat="server" RightToLeft="True" ClientInstanceName="txt_sprepdate">
                                        </dx:ASPxDateEdit>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            ...
                            <dx:LayoutItem Caption="الملاحظات" ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxMemo ID="txt_sprepnotes" runat="server" ClientInstanceName="txt_sprepnotes" Theme="MaterialCompact" Width="100%">
                                        </dx:ASPxMemo>
	...
	txt_empname.GetInputElement().readOnly = true; 
                ...
                <asp:Panel ID="PDetiles" runat="server" BorderStyle="None" Font-Bold="True" Direction="RightToLeft" Style="text-align: right; display: none;" ClientIDMode="Static">
                    <dx:ASPxGridView ID="gvhr_salarydtls" ClientInstanceName="gvhr_salarydtls" runat="server" AutoGenerateColumns="False" RightToLeft="True" Width="100%" EnableTheming="True" Theme="MaterialCompact" ButtonRenderMode="Image" KeyFieldName="salid" OnDataBinding="gvhr_salarydtls_DataBinding" OnRowDeleting="gvhr_salarydtls_RowDeleting" OnCustomCallback="gvhr_salarydtls_CustomCallback">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="empcode" VisibleIndex="4" Caption="كود الموظف" HeaderStyle-Font-Bold="true"  CellStyle-Font-Bold="true">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="empname" VisibleIndex="5" Caption="إسم الموظف" HeaderStyle-Font-Bold="true"  CellStyle-Font-Bold="true">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="basicsarlary" VisibleIndex="6" Caption="الاساسى" HeaderStyle-Font-Bold="true" CellStyle-Font-Bold="true"></dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="vded" VisibleIndex="17" Caption="خصم متغير" HeaderStyle-ForeColor="Red"></dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="sumbenfit" VisibleIndex="18" Caption="اجمالى الاستحقاقات" HeaderStyle-ForeColor="Green" HeaderStyle-Font-Bold="true" CellStyle-Font-Bold="true"></dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="sumdeduction" VisibleIndex="19" Caption="اجمالى الاستقطاعات" HeaderStyle-ForeColor="Red" HeaderStyle-Font-Bold="true" CellStyle-Font-Bold="true"></dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="netsalary" VisibleIndex="20" Caption="الصافى" HeaderStyle-Font-Bold="true" CellStyle-Font-Bold="true">
            ...
            <asp:HiddenField ID="HF_sprepid" ClientIDMode="Static" runat="server" />
