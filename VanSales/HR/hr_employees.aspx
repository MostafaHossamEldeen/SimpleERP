<%@ Page Title="إدارة الموظفين" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="hr_employees.aspx.cs" Inherits="VanSales.HR.hr_employees" %>
        ...
        <ContentTemplate>
            ...
            <div dir="rtl" style="text-align: center; padding-bottom: 20px;">
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete" runat="server" Height="20px" Width="20px" ToolTip="حذف" Image-Url="~/Img/Icon/delete.svg" AutoPostBack="false" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                    <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/HR/employees_del','hf_empid')}" />
                </dx:ASPxButton>
                <button type="button" title="بحث" id="PopUpControlSearch" data-name="emp" data-tablename="hr_employees_sel_pop" data-displayfields="empcode,empname,jobname,empmob"
                    data-displayfieldshidden="empid,empcode,empname,empmob,embemail,empadd,empidno,empbdate,emppic,empnotes,eduname,branchid,ccid,nationid,jobid,empstatus,basicsalary,insursalary,empworkdate,paytypeid,paychartid,empbankname,empbankid,annualvaction,empchatid,chartcodename"
                    data-displayfieldscaption="كود الموظف,إسم الموظف,الوظيفة,الجوال"
                    data-bindcontrols="hf_empid;txt_empcode;txt_empname;txt_empmob;txt_embemail;txt_empadd;txt_empidno;txt_empbdate;hf_imgpath;txt_empnotes;txt_eduname;cmb_branchid;cmb_ccid;cmb_nationid;cmb_jobid;cmb_empstatus;txt_basicsalary;txt_insursalary;txt_empworkdate;cmb_paytypeid;cmb_paychartid;hf_paychartid;txt_empbankname;txt_empbankid;txt_annualvaction;HF_empchatid;txt_empchatid"
                    data-bindfields="empid;empcode;empname;empmob;embemail;empadd;empidno;empbdate;emppic;empnotes;eduname;branchid;ccid;nationid;jobid;empstatus;basicsalary;insursalary;empworkdate;paytypeid;paychartid;paychartid;empbankname;empbankid;annualvaction;empchatid;chartcodename"
                ...
                <dx:ASPxButton  ID="btnback" runat="server" Height="20px" Width="20px" ToolTip="للخلف" Image-Url="~/Img/Icon/back.svg" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                    <ClientSideEvents Click="function(s, e) {location='/hr/hr_employees_master'}"></ClientSideEvents>
                </dx:ASPxButton>
            </div>
            <div class="accordion" id="accordion5">
                <h1 class="accordion__item__header" style="width: 100%;">البيانات الأساسية
                </h1>
                <div class="">
                                        ...
                                        <dx:LayoutItem Caption="كود الموظف ">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="txt_empcode" ClientInstanceName="txt_empcode" runat="server" Theme="MaterialCompact" Font-Bold="True" ForeColor="Black" Text="تلقائي" ClientSideEvents-KeyPress="function(s,e){preventwriteempcode(s,e);}">
                                                    </dx:ASPxTextBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    ...
                                                    <dx:ASPxUploadControl ID="upd_emppic" ClientInstanceName="upd_emppic" OnFileUploadComplete="upd_emppic_FileUploadComplete" FileSystemSettings-GenerateUniqueFileNamePrefix="True" runat="server" UploadMode="Advanced" Width="100%" ShowProgressPanel="True" UploadStorage="FileSystem" ShowUploadButton="True" AutoStartUpload="True" RightToLeft="True" ValidationSettings-GeneralErrorText="فشل رفع الملف بسبب خطأ خارجي" ValidationSettings-MaxFileCountErrorText="تمت إزالة {0} ملف (ملفات) من التحديد لأنها تتجاوز حد الملفات المراد رفعها في وقت واحد (والذي تم تعيينه على {1})." ValidationSettings-MaxFileSizeErrorText="يتجاوز حجم الملف الحد الأقصى للحجم المسموح به ، وهو {0} بايت" ValidationSettings-NotAllowedFileExtensionErrorText="امتداد الملف هذا غير مسموح به" Theme="MaterialCompact" ShowTextBox="False" ToolTip="رفع صورة الموظف">
                                                        ...
                                                        <ClientSideEvents FileUploadComplete="function(s, e) {updmsg(s,e);}"></ClientSideEvents>
                    ...
                    <asp:HiddenField ID="hf_paychartid" ClientIDMode="Static" runat="server"  />
                            ...
                            <dx:LayoutGroup ColCount="3" GroupBoxDecoration="None">
                                ...
                                <Items>
                                    <dx:LayoutItem Caption="طريقة صرف الراتب ">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxComboBox ID="cmb_paytypeid" ClientInstanceName="cmb_paytypeid" runat="server" Theme="MaterialCompact" Font-Bold="True">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { OnCountryChanged(s); }" />
                                                </dx:ASPxComboBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                ...
                                <Items>
                                    <dx:LayoutItem Caption="حساب الموظف">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                ...
                                                <button type="button" id="Pop_chart" data-name="chart" onclick="createPopUp($(this))" data-tablename="gl_chart_sel_pop" data-displayfields="chartcode,chartname" data-displayfieldshidden="chartid"
                                                    data-displayfieldscaption="كود الحساب,اسم الحساب" data-bindcontrols="txt_empchatid;HF_empchatid"
                                                    data-bindfields="chartcodename;chartid" data-pkfield="chartid" data-apiurl="/VanSalesService/Vouchers/chartSearch" data-paramaternames="HF_legertype" class="btn btn-sm btnsearchpopup" tabindex="1" />
                                                <asp:HiddenField ID="HF_legertype" ClientIDMode="Static" runat="server" Value="1" />
                                                <asp:HiddenField ID="HF_empchatid" ClientIDMode="Static" runat="server" />
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                </Items>
