<%@ Page Title="تقرير السلف" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="hr_loan_report.aspx.cs" Inherits="VanSales.HR.hr_loan_report" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td class="text-center" style="background-color: #dcdcdc">
                    <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="تقرير السلف" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" ForeColor="#35B86B"></dx:ASPxLabel>
                </td>
            </tr>
        </table>
    </div>
        ...
        <ContentTemplate>
            ...
            <div dir="rtl" style="text-align: center;">
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="ASPxbtnexpandcollapse" runat="server" Height="20px" Width="20px" ToolTip="إظهار التفاصيل" Image-Url="~/Img/Icon/expand.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                    <ClientSideEvents Click="function(s, e) {if (this.ToolTip == &quot;اظهار الكل&quot;) {gv_loan.CollapseAll();this.ToolTip = &quot;اخفاء الكل&quot;;}else {gv_loan.ExpandAll();this.ToolTip = &quot;اظهار الكل&quot;;}}"></ClientSideEvents>
                </dx:ASPxButton>
            </div>
<dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" RightToLeft="True">
	...
	txt_empname.GetInputElement().readOnly = true; 
            ...
            <dx:ASPxGridView ID="gv_loan" ClientInstanceName="gv_loan" SettingsText-Title="تقرير السلف" runat="server" AutoGenerateColumns="False" EnableCallBacks="False" KeyboardSupport="true" AccessKey=" " OnCustomSummaryCalculate="gv_loan_CustomSummaryCalculate" OnDataBinding="gv_loan_DataBinding" Width="100%" RightToLeft="True" CssClass="grid" OnHtmlRowPrepared="gv_loan_HtmlRowPrepared">
                ...
                <GroupSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="loanvalue" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="loanvalue"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="loanpay" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="loanpay"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="notes" DisplayFormat=" {0}" ShowInGroupFooterColumn="notes" ShowInColumn="notes" SummaryType="Custom"></dx:ASPxSummaryItem>
                </GroupSummary>
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn FieldName="loandate" VisibleIndex="2" Caption="التاريخ"></dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="loanvalue" VisibleIndex="3" Caption="سلفة"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="loantype" VisibleIndex="4" Caption="نوع السلفة"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="loanpay" VisibleIndex="5" Caption="سداد"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="paytype" VisibleIndex="6" Caption="نوع السداد"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="notes" VisibleIndex="7" Caption="شرح الحركة"></dx:GridViewDataTextColumn>
                </Columns>
                <SettingsPopup>
                    <EditForm Width="730">
                ...
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="empcode" SummaryType="Count" DisplayFormat="العددالكلى = 0" ShowInGroupFooterColumn="empcode"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="loanvalue" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="loanvalue"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="loanpay" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="loanpay"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="notes" DisplayFormat=" {0}" ShowInGroupFooterColumn="notes" ShowInColumn="notes" SummaryType="Custom"></dx:ASPxSummaryItem>
                </TotalSummary>
            ...
            <dx:ASPxGridViewExporter ID="gvempsalaryvarExporter" runat="server" FileName="السلف" GridViewID="gv_loan" PaperKind="A4" PaperName="السلف" RightToLeft="True" Landscape="True">
                <PageHeader Center="السلف" Font-Bold="true">
                </PageHeader>
