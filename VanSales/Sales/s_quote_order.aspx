<%@ Page Title="عرض الاسعار" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="s_quote_order.aspx.cs" Inherits="VanSales.Sales.s_quote_order" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="../Scripts/App/sales/quote_order.js"></script>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="عرض الأسعار" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
	...
	validate(s, e);
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                    ...
                    <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/orders/quoteorderDel', 'HF_soid') }" />
                  <%--  <ClientSideEvents Click="function(s, e) {delData('/Sales/s_quote_order.aspx/Deletedata' ,'soid','HF_soid') }" />--%>


                    <Image Height="20px" Url="~/img/icon/delete.svg" Width="20px"></Image>
                </dx:ASPxButton>               
                <button type="button" id="PopUpControlSearch" data-name="inv" data-tablename="s_quote_order_sel_search" data-displayfields="sono,sodocno,sodate"
                    data-displayfieldshidden="branchid,custid,custname,ouser,sonotes,netbvat,vatvalue,netavat,soid,sinvc"
                    data-displayfieldscaption="رقم عرض الاسعار,الرقم اليدوى,التاريخ"
                ...
                <dx:ASPxFormLayout runat="server" ID="formLayout" CssClass="formLayout" RightToLeft="True">
                    ...
                    <Items>
                        <dx:LayoutGroup ColCount="4" GroupBoxDecoration="Box" Caption="البيانات الاساسيه">
                            <Items>
                                <dx:LayoutItem Caption="رقم عرض الاسعار">
                                ...
                                <dx:LayoutItem Caption="رقم يدوى لعرض الاسعار">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                               ...
                               <%-- <dx:LayoutItem Caption="امر الاسعار/عرض اسعار">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
            ...
            <div dir="rtl">
                <asp:Panel ID="PDetiles" runat="server" ClientIDMode="Static" BorderStyle="None" Font-Bold="True" Direction="RightToLeft" Style="text-align: right; display: none;">
                    <dx:ASPxFormLayout SettingsItemCaptions-Location="Top" runat="server" ID="ASPxFormLayout1" CssClass="formLayout" RightToLeft="True">
                        <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="900" />
                        <Items>
                            <dx:LayoutGroup ColCount="14" GroupBoxDecoration="box" Caption="اصناف عرض الاسعار" UseDefaultPaddings="false" CellStyle-Font-Bold="true">
 ...
 KeyUp="function(s, e) {multiply()}" />
	...
	txt_itemvatvalue.GetInputElement().readOnly = true; 
                                    ...
                                    <dx:LayoutItem Caption="" ColumnSpan="2"  Paddings-PaddingTop="11" Paddings-PaddingBottom="13" ParentContainerStyle-Paddings-PaddingLeft="0" ParentContainerStyle-Paddings-PaddingRight="0">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
	...
	validate_dtl(s, e);
                                                ...
                                                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete_dtls" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete_dtls" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                                                    ...
                                                    <ClientSideEvents Click="function(s, e) {getgvrow();delData_Detail('/VanSalesService/orders/gquoteorderDtl', 'sodtlid', 'HF_sodtlid',gvs_orderdtls) }" />
                    ...
                    <dx:ASPxGridViewExporter ID="gvitemsExporter" runat="server" FileName="اصناف عرض الاسعار" GridViewID="gvs_orderdtls" PaperKind="A4" PaperName="اصناف امر الاسعار" RightToLeft="True" Landscape="True">
                        <PageHeader Center="أصناف عروض الاسعار" Font-Bold="true">
                        </PageHeader>
    ...
    <%--    <div class="form-group row">
     ...
     <div class="custgroup row">
        ...
        <div   class="col-md-6 " >
            ...
            <button type="button" class="btn btn-sm addcustpopup " onclick="QuoteCustData()" >
