<%@ Page Title="تقرير اجمالى طرق دفع المبيعات" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="total_inv_pay.aspx.cs" Inherits="VanSales.Sales.total_inv_pay" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                <td class="text-center" style="background-color: #dcdcdc">
                    <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="تقرير اجمالى طرق دفع المبيعات" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                </td>
            </tr>
        </table>
    </div>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <Items>
                          <%--  <dx:LayoutItem Caption="">
                            ...
                            <dx:LayoutItem Caption="">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox ID="chk_sinv" runat="server" Text="اجمالى المبيعات" AutoPostBack="true" OnCheckedChanged="chk_payname_CheckedChanged" Checked="true" ClientInstanceName="chk_sinv"   ></dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox ID="chk_rtninv" runat="server" Text="اجمالى المرتجع" AutoPostBack="true" OnCheckedChanged="chk_payname_CheckedChanged" Checked="true" ClientInstanceName="chk_rtninv"></dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                               ...
                               <dx:LayoutItem Caption="">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox ID="chk_total" runat="server" Text="صافى القيمه" AutoPostBack="true" OnCheckedChanged="chk_payname_CheckedChanged" Checked="true" ClientInstanceName="chk_total"></dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
            ...
            <dx:ASPxGridView ID="gvs_inv_pay" ClientInstanceName="gvs_inv_pay" SettingsText-Title=" تقرير اجمالى طرق دفع المبيعات" runat="server" AutoGenerateColumns="False" EnableCallBacks="False" KeyboardSupport="true" AccessKey=" "   OnDataBinding="gvs_inv_pay_DataBinding" Width="100%" KeyFieldName="invdtlid" Theme="MaterialCompact" RightToLeft="True" CssClass="grid">
                ...
                <Columns >
                    ...
                    <dx:GridViewDataTextColumn FieldName="payname" VisibleIndex="1" Caption="طريقه الدفع" >
                    ...
                    <dx:GridViewDataTextColumn FieldName="sinv" VisibleIndex="3"  Caption="إجمالي المبيعات" >
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="rtninv" VisibleIndex="4" Caption="إجمالي المرتجع"   >
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="total" VisibleIndex="5"  Caption="الصافى" >
                    </dx:GridViewDataTextColumn>
          ...
          <%--      <GroupSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="invQty" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="كمية المبيعات"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="invvalue" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="قيمه المبيعات"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="rtnQty" SummaryType="Sum" DisplayFormat=" {0}" ShowInGroupFooterColumn="كميه المرتجع"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="rtnvalue" SummaryType="Sum" DisplayFormat="{0}" ShowInGroupFooterColumn="إجمالي المرتجع"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="totalQty" SummaryType="Sum" DisplayFormat="{0}" ShowInGroupFooterColumn="صافي الكميه"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="totalvalue" SummaryType="Sum" DisplayFormat="{0}" ShowInGroupFooterColumn="صافي القيمه"></dx:ASPxSummaryItem>
                </GroupSummary>--%>
                ...
                <TotalSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="sinv" SummaryType="Sum" DisplayFormat=" {0}" />
                    <dx:ASPxSummaryItem FieldName="rtninv" SummaryType="Sum" DisplayFormat=" {0}" />
