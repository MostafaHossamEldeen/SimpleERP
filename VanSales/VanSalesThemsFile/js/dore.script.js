...
$.dore = function(element, options) {
  ...
  function init() {
    ...
    var searchHiddenBreakpoint = 300;
    var menuHiddenBreakpoint = 300;
    ...
    var firstInit = true;
      ...
      if (windowWidth < menuHiddenBreakpoint) {
        ...
        if (
          ...
          //"Pinned", !isPinnded
          if (localStorage.getItem("Pinned") == 'false') {
              setMenuClassNames(1, true);
              document.querySelector('#freeze').setAttribute('class', 'ti-pin2');
          } else if (localStorage.getItem("Pinned") == 'true') {
              setMenuClassNames(0, true);
              document.querySelector('#freeze').setAttribute('class', 'simple-icon-pin');
              setMenuClassNames(0);
          } else {
              setMenuClassNames(1);
          }
        ...
        if (localStorage.getItem('ClassName') != null) {
            $('#topheader .list-unstyled').find('li.active').removeClass('active');

            var id = localStorage.getItem('ClassName');
            $(`#${id}`).addClass('active');
        }
      }
      ...
      function setMenuClassNames(clickIndex, calledFromResize, link) {
          ...
          if (clickIndex % 4 == 0) {
              ...
              if (
                  ...
                  console.log(`mouse click count ${clickIndex} % 4 == 1 ===> 1`);
              } else if (isClassIncludedApp("menu-default")) {
                  nextClasses = "menu-default sub-hidden";
                  console.log(`mouse click count ${clickIndex} % 4 == 1 ===> 2`);
              } else if (isClassIncludedApp("menu-sub-hidden")) {
                  nextClasses = "menu-sub-hidden main-hidden sub-hidden";
                  console.log(`mouse click count ${clickIndex} % 4 == 1 ===> 3`);
              } else if (isClassIncludedApp("menu-hidden")) {
                  nextClasses = "menu-hidden main-show-temporary";
                  console.log(`mouse click count ${clickIndex} % 4 == 1 ===> 4`);
              }
              ...
              // console.log(`mouse click count ${clickIndex} % 4 == 3`);
              if (
                  isClassIncludedApp("menu-default") //&& isClassIncludedApp("menu-sub-hidden")
              ) {
                  nextClasses = "menu-default menu-sub-hidden sub-show-temporary";
                  if ("Pinned", isPinnded) {
                      //nextClasses = "menu-default sub-hidden";
                      console.log(`mouse click count ${clickIndex} % 4 == 3 ===> 2`);
                  ...
                  console.log(`mouse click count ${clickIndex} % 4 == 3 ===> 1`);
              } else if (isClassIncludedApp("menu-default")) {
                  nextClasses = "menu-default sub-hidden";
                  console.log(`mouse click count ${clickIndex} % 4 == 3 ===> 2`);
              } else if (isClassIncludedApp("menu-sub-hidden")) {
                  // nextClasses = "menu-sub-hidden sub-show-temporary";
                  // console.log(`mouse click count ${clickIndex} % 4 == 3 ===> 3`);
                  if ("Pinned", isPinnded) {
                      //nextClasses = "menu-default sub-hidden";
                      console.log(`mouse click count ${clickIndex} % 4 == 3 ===> 3`);
                  ...
                  nextClasses = "menu-hidden main-show-temporary";
                  console.log(`mouse click count ${clickIndex} % 4 == 3 ===> 4`);
          ...
          // if(isPinnded  && nextClasses=="menu-sub-hidden main-hidden sub-hidden" )
          // {
          //   alert(3)
          //   nextClasses = "menu-default sub-hidden";
          //   container.removeClass(allMenuClassNames);
          //   container.addClass(nextClasses);
          // }
          // else if(isPinnded  && nextClasses=="menu-default menu-sub-hidden main-hidden sub-hidden" )
          // {
          ...
          //   container.addClass(nextClasses);
          // }
          // else if(isPinnded  && nextClasses=="menu-default menu-sub-hidden" )
          // {

          //   nextClasses = " sub-hidden";
          //   container.removeClass(allMenuClassNames);
          //   container.addClass(nextClasses);
          // }
          // else if(isPinnded && clickIndex % 4 == 0)
          // {
          //   nextClasses = "sub-hidden";
          //   container.removeClass(allMenuClassNames);
          //   container.addClass(nextClasses);
          ...
          console.log(`mouse click count ${menuClickCount}`);
      }
      // *******************************************************
      // Pinned button event
      var isPinnded = JSON.parse(localStorage.getItem("Pinned")) || false;
      console.log(`isPenned default value :: ${isPinnded}`);
      // var pinButton = document.querySelector('.simple-icon-pin');
      const pinButton = document.querySelector('#freeze');
      ...
      function hideMenu() {
          if (isPinnded) {
              pinButton.setAttribute('class', 'ti-pin2');
              $("#app-container").removeClass(allMenuClassNames);
              $("#app-container").addClass("menu-sub-hidden sub-hidden");

              // isPinnded = false;
          } else {
              pinButton.setAttribute('class', 'simple-icon-pin');
              $("#app-container").removeClass(allMenuClassNames);
          ...
          isPinnded = !isPinnded;
          localStorage.setItem("Pinned", isPinnded);
          console.log(`isPenned changed value :: ${isPinnded}`);

          //   const subMenu = document.querySelector('.sub-menu');
          // subMenu.setAttribute('class', 'sub-menu-pin');  
          // resizeCarousel();
          // document.querySelector('#mano').setAttribute('class','mainpin');
      }
      // Pinned button event
      // *******************************************************

      $('#app-container').on('load', function (event) {
          event.preventDefault();
          console.log('first load to html file');
          // event.preventDefault();
          // $("#app-container").removeClass(allMenuClassNames);
          // $("#app-container").addClass("menu-sub-hidden sub-hidden");
      });
    ...
    showSubMenu($(".main-menu ul li.active a").attr("href"));
      ...
      $('#topheader .list-unstyled a').on('click', function () {
          
          $('#topheader .list-unstyled').find('li.active').removeClass('active');

          $(this).parent('li').addClass('active');
          var id = $('#topheader .list-unstyled').find('li.active').attr('id');
          console.log('active li id :: ' + id);

          localStorage.setItem('ClassName', id);
      });
    ...
    $("body > *")
     ...
     // $('#emaxspiner').css("display", "none")
      $('#emaxcontent').css("display", "")
