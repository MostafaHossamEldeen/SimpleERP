...
{
    public partial class RepBalanceSheetStatment : EmaxBasepage
    {
        DataTable dt;
        ...
        protected void ASPxGridView1_DataBinding(object sender, EventArgs e)
        {
            ...
            dt= SqlCommandHelper.ExcecuteToDataTable("BlanceSheet_Statment", dict).dataTable;
            
            ASPxGridView1.DataSource = Emax.SharedLib.Utility.AcoStatmentHelper.PrepareBalanceSheetStatment(dt,dtefrom.Value,dteto.Value
                ,EmaxGlobals.NullToEmpty( cmb_levelno.Value));
        ...
        protected void ASPxButton2_Click(object sender, EventArgs e)
        {
            ...
            PrintPage("GL/RepBalanceSheetStatment.repx", reptb, dict);
        }
