<%@ Page Title="سندات القبض" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rec_doc.aspx.cs" Inherits="VanSales.GL.rec_doc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="../Scripts/App/GL/rec_doc.js"></script>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="Lbl_Tittle" runat="server" Text="سندات القبض" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
	...
	validate(s, e);
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                    ...
                    <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/rec/recdocDelMaster', 'HF_recid') }" />

                    <Image Height="20px" Url="~/img/icon/delete.svg" Width="20px"></Image>
                </dx:ASPxButton>

                <button type="button" id="PopUpControl1" data-name="nav" data-tablename="rec_doc_sel_search" data-displayfields="recno,recbranchid,recdate"
                    data-displayfieldshidden="ccname,recdocno,branchname,recman,recvalue,ccid,recnotes,paytypeid,paychartid,paytypename,postacc,vchrid,payref,fromchartid,paynotes,rectype,rectypenamem,recdocimg,recid,vochrno,recuser"
                    data-displayfieldscaption=" رقم السند,الفرع,التاريخ" data-bindcontrols="txt_recno;txt_recdocno;cmb_recbranchid;txt_recdate;txt_recman;txt_recvalue;cmb_ccid;txt_recnotes;cmb_paytypeid;HF_paychartid;HF_postacc;txt_payref;HF_fromchartid;txt_paynotes;cmb_rectype;lbl_recdocimg;lbl_recdocimg1;HF_recid;txt_vochrid;txt_recuser"
                    data-bindfields="recno;recdocno;recbranchid;recdate;recman;recvalue;ccid;recnotes;paytypeid;paychartid;postacc;payref;fromchartid;paynotes;rectype;recdocimg;recdocimg;recid;vochrno;recuser" 
                    data-apiurl="/VanSalesService/items/FillPopup" data-pkfield="recid" onclick="createPopUp($(this),'popupModalsearch')" class="btn btn-sm btnsearchpopup">
                </button>
                ...
                <ClientSideEvents Click="function(s, e) {postRecDocAcc();}" />
                            ...
                            <dx:LayoutItem Caption="رقم السند" >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ValidationSettings-CausesValidation="true" ID="txt_recno" runat="server" ClientInstanceName="txt_recno" Theme="MaterialCompact" Font-Bold="True" ForeColor="Black" Text="تلقائى">
	 ...
	 preventwrite(s, e)
                            ...
                            <dx:LayoutItem Caption="رقم يدوى للسند">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_recdocno" ClientInstanceName="txt_recdocno" runat="server" Theme="MaterialCompact" Style="margin-right: 0px">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="التاريخ">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        ...
                                        <dx:ASPxDateEdit ID="txt_recdate" runat="server" ValidateRequestMode="Disabled" RightToLeft="True" Theme="MaterialCompact" MinDate="1900-01-01" ClientInstanceName="txt_recdate">
                                        </dx:ASPxDateEdit>
                            ...
                            <dx:LayoutItem Caption="الفرع"  >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxComboBox ID="cmb_recbranchid" runat="server" ClientInstanceName="cmb_recbranchid" RightToLeft="True" TextField="citemname" Theme="MaterialCompact" ValueField="citemid" AutoPostBack="false">
                                        </dx:ASPxComboBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="نوع القبض">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxComboBox ID="cmb_rectype" runat="server" ClientInstanceName="cmb_rectype" RightToLeft="True" TextField="citemname" Theme="MaterialCompact" ValueField="citemid">
                                            <ClientSideEvents ValueChanged="function(s, e) {
                                                  if(cmb_rectype.GetSelectedIndex() == 0)
                                                  {
                                                  cmb_smanid.enabled = true;
                                                  }
                                                  else
                                                  {
                                                  cmb_smanid.GetSelectedItem = -1;
                                                  cmb_smanid.ClearItems();
                                                  cmb_smanid.enabled = false;
                                                  cmb_smanid.SetValue(null);
                                                  }
                            ...
                            <dx:LayoutItem Caption="اسم المندوب">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxComboBox ID="cmb_smanid" runat="server" ClientInstanceName="cmb_smanid" RightToLeft="True" TextField="citemname" Theme="MaterialCompact" ValueField="citemid" ClearButton-DisplayMode="Always">
                                        </dx:ASPxComboBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="حساب المسدد" Width="25%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_fromchartid" runat="server" Theme="MaterialCompact" ClientInstanceName="txt_fromchartid">
                                         <ClientSideEvents ValueChanged="function(s, e) {setfromchartData(s, e)}" Init="function(s, e) {chart_validate()}" />
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                                ...
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ForeColor="Red">
                                        ...
                                        <button type="button" id="Pop_chart" data-name="chart" onclick="createPopUp($(this))" data-tablename="gl_chart_sel_pop" data-displayfields="chartcode,chartname" data-displayfieldshidden="chartid"
                                            data-displayfieldscaption="كود الحساب,اسم الحساب" data-bindcontrols="txt_fromchartid;txt_fromchartname;HF_fromchartid"
                            ...
                            <dx:LayoutItem Caption="اسم حساب المسدد">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_fromchartname" runat="server" Theme="MaterialCompact" ClientInstanceName="txt_fromchartname">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            ...
                            <dx:LayoutItem Caption="المستلم">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_recman" runat="server" Theme="MaterialCompact" ClientInstanceName="txt_recman">
	...
	txt_recman.GetInputElement().readOnly = true; 
                            ...
                            <dx:LayoutItem Caption="المستخدم"  >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_recuser" runat="server" Theme="MaterialCompact" ClientInstanceName="txt_recuser">
                                            <ClientSideEvents Init="function(s, e) {
	txt_recuser.GetInputElement().readOnly = true; 
}" />
                                        </dx:ASPxTextBox>
                                ...
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                         <dx:ASPxHyperLink ID="txt_vochrid" runat="server" ClientInstanceName="txt_vochrid" Font-Bold="True" ForeColor="#009933" Font-Size="Medium">
                                                <ClientSideEvents Click='function(s, e) {
	window.open("/GL/Vouchers.aspx?vchrno="+txt_vochrid.GetValue(),"_blank")
}'></ClientSideEvents>
                                            </dx:ASPxHyperLink>
                                        <%--<dx:ASPxHyperLink ID="txt_vchrid" runat="server" ClientInstanceName="txt_vchrid">
                                        </dx:ASPxHyperLink>--%>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="المستند" Width="50%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        ...
                                        <dx:ASPxLabel ID="lbl_recdocimg1" ClientInstanceName="lbl_recdocimg1" runat="server" Theme="MaterialCompact" ForeColor="#009933" Width="80%">
                                        </dx:ASPxLabel>
                            ...
                            <dx:LayoutItem Caption="الملاحظات" ColumnSpan="3">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxMemo ID="txt_recnotes" ClientInstanceName="txt_recnotes" runat="server" Theme="MaterialCompact" Width="100%">
                                        </dx:ASPxMemo>
            ...
            <asp:HiddenField runat="server" ClientIDMode="Static" ID="lbl_recdocimg" />
            <asp:HiddenField runat="server" ClientIDMode="Static" ID="HF_paychartid" />
            <asp:HiddenField runat="server" ClientIDMode="Static" ID="HF_fromchartid" />
            <asp:HiddenField ID="HF_recid" ClientIDMode="Static" runat="server" />
        </ContentTemplate>
        <Triggers>
