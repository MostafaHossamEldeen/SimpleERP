<%@ Page Title="المصاريف" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="VanSales.Sys.Expenses" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="../Scripts/App/GL/Expenses.js"></script>
        ...
        <ContentTemplate>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="Lbl_Tittle" runat="server" Text="المصاريف" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div dir="rtl" style="text-align: center;">
                ...
                <dx:ASPxButton ID="btn_delete" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف"  >
                    <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/Expenses/Expenses_del','hf_expid')}" />
                ...
                <Items>
                    <dx:LayoutGroup ColCount="5" GroupBoxDecoration="Box" Caption="">
                        <Items>
                            ...
                            <dx:LayoutItem Caption="اسم المصروف">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <asp:HiddenField ID="hf_hidden1" runat="server" ClientIDMode="Static" Value="0" />
                                        <dx:ASPxTextBox ID="txt_expname" ClientInstanceName="txt_expname" runat="server" Width="100%"  ></dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
            ...
            <asp:HiddenField ID="hf_expid" runat="server" ClientIDMode="Static" Value="0"/>
            <br />
            <dx:ASPxGridView ID="gvexpenses" ClientInstanceName="gvexpenses" runat="server"   AutoGenerateColumns="False" RightToLeft="True" Width="100%" EnableTheming="True" Theme="MaterialCompact" ButtonRenderMode="Image" KeyFieldName="gvexpenses" OnDataBinding="gvexpenses_DataBinding" ClientSideEvents-RowDblClick="function(s,e){gv_BindExpenses(s,e)  ;}">
                ...
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="expid" ReadOnly="True" VisibleIndex="0" Visible="false">
                        <EditFormSettings Visible="False"></EditFormSettings>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="expname" VisibleIndex="1" Caption="اسم المصروف" ></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="accid" VisibleIndex="2" Visible="false"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="exptype" VisibleIndex="3" Visible="false" >
                    </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn FieldName="chartname" VisibleIndex="4" Caption="اسم الحساب">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="chartcode" VisibleIndex="5" Caption="كود الحساب" >
                    </dx:GridViewDataTextColumn>
                </Columns>
                <SettingsPopup>
                    <EditForm Width="730">
                ...
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="chartcode" ShowInColumn="expname" ShowInGroupFooterColumn="expname" SummaryType="Count" DisplayFormat="العدد : {0}" />
                </TotalSummary>
                <GroupSummary>
                    <dx:ASPxSummaryItem FieldName="chartcode" SummaryType="Count" />
                </GroupSummary>
                <Styles>
            ...
            <dx:ASPxGridViewExporter ID="gvexpensesExporter" runat="server" FileName="المصاريف" GridViewID="gvexpenses" PaperKind="A4" PaperName="المصاريف" RightToLeft="True" Landscape="True">
                        <PageHeader Center="المصاريف" Font-Bold="true">
                        </PageHeader>
...
<%--function deldata() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    gvexpenses.GetSelectedFieldValues("itempic", onvaluechanged);
                } else if (
