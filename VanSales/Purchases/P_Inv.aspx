<%@ Page Title="فاتورة المشتريات" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="P_Inv.aspx.cs" Inherits="VanSales.Purchases.inv" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="../Scripts/App/Purchases/P_Inv.js"></script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="فواتـــــير الــشــراء" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div dir="rtl" style="text-align: center;">
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_Save" ClientInstanceName="btn_Save" runat="server" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حفظ" OnClick="btn_Save_Click">
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                    <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/P_inv/DelPinv','HF_pinvid')}" />
                    <Image Height="20px" Url="~/img/icon/delete.svg" Width="20px"></Image>
                </dx:ASPxButton>
                <button type="button" title="بحث" id="PopUpControlSearch" data-name="inv" data-tablename="p_inv_sel_popup" data-displayfields="pinvno,pinvdocno,pinvdate"
                    ...
                    data-displayfieldscaption="رقم الفاتوره,رقم فاتورة المورد,التاريخ"
                    data-bindcontrols="txt_pinvno;txt_pinvdocno;txt_pinvdate;HF_pinvid;cmb_pinvpay;cmb_branchid;cmb_ccid;txt_suppid;txt_suppname;txt_suppvat;txt_puser;txt_pnotes;txt_netbvat;txt_vatvalue;txt_netavat;HF_docid;txt_docno;lbl_invpic;rbl_vattype;hf_postst;hf_postacc;hf_vochrno"
                    data-bindfields="pinvno;pinvdocno;pinvdate;pinvid;pinvpay;branchid;ccid;suppid;suppname;suppvat;puser;pnotes;netbvat;vatvalue;netavat;docid;docno;invpic;vattype;postst;postacc;vochrno"
                ...
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_postst" runat="server" ClientInstanceName="btn_postst" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="ترحيل مستودعات">
                    ...
                    <ClientSideEvents Click="function(s,e){postp_InvStock(s,e);}" />
                </dx:ASPxButton>
                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_postacc" runat="server" ClientInstanceName="btn_postacc" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="ترحيل حسابات">
                    <Image Height="20px" Url="~/img/icon/Unt512.png" Width="20px"></Image>
                       <ClientSideEvents Click="function(s,e){postp_InvAcc(s,e);}" />
                </dx:ASPxButton>
            ...
            <br />
            <asp:HiddenField runat="server" ClientIDMode="Static" ID="hf_postst" Value="0"/>
            <asp:HiddenField runat="server" ClientIDMode="Static" ID="hf_postacc" Value="0"/>
                        ...
                        <dx:LayoutGroup ColCount="5" GroupBoxDecoration="Box" Caption="البيانات الاساسيه">
                            <Items>
                                <dx:LayoutItem Caption="رقم الفاتوره">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="txt_pinvno" runat="server" ClientInstanceName="txt_pinvno" Theme="MaterialCompact" Font-Bold="True" ForeColor="Black" Text="تلقائى">
                                                <ClientSideEvents KeyDown="function(s,e){preventwrite(s,e);}" />
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="رقم فاتورة المورد">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="txt_pinvdocno" runat="server" ClientInstanceName="txt_pinvdocno" Theme="MaterialCompact" Style="margin-right: 0px">
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="نوع سداد الفاتوره">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_pinvpay" runat="server" ClientInstanceName="cmb_pinvpay" RightToLeft="True" AutoPostBack="false">
                                            </dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                ...
                                <dx:LayoutItem Caption="مراكز التكلفه">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_ccid" runat="server" ClientInstanceName="cmb_ccid" RightToLeft="True" AutoPostBack="false" ClearButton-DisplayMode="Always">
                                            </dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="أمر / طلبية شراء" Paddings-PaddingTop="16">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxHyperLink ID="txt_docno" runat="server" ClientInstanceName="txt_docno" Font-Bold="True" ForeColor="#009933" Font-Size="Medium">
                                                <%--<ClientSideEvents Click="function(s, e){window.open(&quot;/Purchases/Orders.aspx?poid=&quot;+$(&#39;#HF_docid&#39;).val(),&quot;_blank&quot;)}"></ClientSideEvents>--%>
                                            </dx:ASPxHyperLink>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                        ...
                        <dx:LayoutGroup ColCount="6" GroupBoxDecoration="None" UseDefaultPaddings="false" Paddings-PaddingTop="10">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem Caption="الملاحظات" ColumnSpan="3" Width="32%">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxMemo ID="txt_pnotes" runat="server" ClientInstanceName="txt_pnotes" Theme="MaterialCompact" Width="100%">
                                            </dx:ASPxMemo>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="المستند" Paddings-PaddingTop="10">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <asp:FileUpload ID="fub_invpic" ClientIDMode="Static" runat="server" />
                                            <dx:ASPxLabel ID="lbl_invpic" ClientInstanceName="lbl_invpic" runat="server" Theme="MaterialCompact" ForeColor="#009933" Width="50%">
                                            </dx:ASPxLabel>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_upload" runat="server" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="رفع ملف" OnClick="btn_upload_Click">
                                                <Image Height="20px" Url="~/img/icon/import.svg" Width="20px"></Image>
                                            </dx:ASPxButton>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_download" runat="server" AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="تحميل" OnClick="btn_download_Click">
	...
	window.open("/GL/Vouchers.aspx?vchrno="+lbl_vochrno.GetValue(),"_blank")
            ...
            <div dir="rtl">
                <asp:Panel ID="PDetiles" runat="server" BorderStyle="None" Font-Bold="True" Direction="RightToLeft" Style="text-align: right; display: none;">
                    <dx:ASPxFormLayout SettingsItemCaptions-Location="Top" runat="server" ID="ASPxFormLayout1" CssClass="formLayout" RightToLeft="True">
                        <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="900" />
                        <Items>
                            <dx:LayoutGroup ColCount="13" GroupBoxDecoration="box" Caption="اصناف الفاتوره" UseDefaultPaddings="false" CellStyle-Font-Bold="true">
                                ...
                                <Items>
                                    ...
                                    <dx:LayoutItem Caption="" Paddings-PaddingTop="15" ParentContainerStyle-Paddings-PaddingLeft="2" ParentContainerStyle-Paddings-PaddingRight="2" Paddings-PaddingBottom="13">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <button type="button" id="puop_item" data-name="items" onclick="createPopUp($(this))" data-tablename="st_itemunit_sel_pop_p_inv"
                                                    ...
                                                    data-bindcontrols="txt_itemcode;txt_itemname;txt_unitname;HF_itemid;HF_factor;HF_unitid;txt_price;Hf_vat"
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                ...
                                                <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete_dtls" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete_dtls" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                                                    <ClientSideEvents Click="function(s, e) {getgvdtlrow();delData_Detail('/VanSalesService/P_inv/DelDtl', 'invdtlid', 'HF_invdtlid',gv_pinvdtls) }" />
                                                    <Image Height="20px" Url="~/img/icon/delete.svg" Width="20px"></Image>
                                                </dx:ASPxButton>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                    ...
                    <asp:HiddenField ID="HF_invdtlid" runat="server" ClientIDMode="Static" Value="0" />
                    <dx:ASPxGridView ID="gv_pinvdtls" ClientInstanceName="gv_pinvdtls" runat="server" AutoGenerateColumns="False" EnableCallBacks="False" KeyboardSupport="true" AccessKey="" Width="100%" KeyFieldName="invdtlid" Theme="MaterialCompact" RightToLeft="True" ClientSideEvents-RowDblClick="function(s,e){gv_Bind_dtl(s,e);}" OnDataBinding="gv_pinvdtls_DataBinding" OnDataBound="gv_pinvdtls_DataBound" OnCustomCallback="gv_pinvdtls_CustomCallback">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="vatvalue" VisibleIndex="16" Caption="الضريبة">
                            </dx:GridViewDataTextColumn>
                        </Columns>
                        ...
                        <TotalSummary>
                            ...
                            <dx:ASPxSummaryItem FieldName="vatvalue" ShowInColumn="الضريبة" SummaryType="Sum" DisplayFormat="{0}" />
                    ...
                    <dx:ASPxGridViewExporter ID="gvitemsExporter" runat="server" FileName="اصناف الفاتوره" GridViewID="gv_pinvdtls" PaperKind="A4" PaperName="اصناف الفاتوره" RightToLeft="True" Landscape="True">
            ...
            <%------------------------------------------------------------------------------------------------%>
            <%------------------------------------------------------------------------------------------------%>
            <asp:Panel ID="p_invexp" runat="server" BorderStyle="None" Font-Bold="True" Direction="RightToLeft" Style="text-align: right; display: none">
                <dx:ASPxFormLayout SettingsItemCaptions-Location="Top" runat="server" ID="ASPxFormLayout3" CssClass="formLayout" RightToLeft="True">
                    <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="900" />
                    <Items>
                        <dx:LayoutGroup ColCount="6" GroupBoxDecoration="box" Caption="المصروفات" UseDefaultPaddings="false" Paddings-PaddingTop="10" CellStyle-Font-Bold="true">
                            <Paddings PaddingTop="10px" />
                            <CellStyle Font-Bold="True">
                            </CellStyle>
                            <Items>
                                <dx:LayoutItem Caption="المصروف">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_expid" runat="server" ClientInstanceName="cmb_expid" Theme="MaterialCompact" RightToLeft="True" ClearButton-DisplayMode="Always"></dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem Caption="القيمه">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="txt_expvalue" runat="server" Theme="MaterialCompact" Text="0" ClientInstanceName="txt_expvalue">
                                                <ClientSideEvents GotFocus="function(s, e) {txt_expvalue.SelectAll();}" KeyPress="function(s, e) {decimale3num(s, e)}" />
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                ...
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <asp:HiddenField ID="hf_accpaidid" runat="server" ClientIDMode="Static" Value="0" />
                                        <dx:ASPxTextBox ID="txt_chartcode" ClientInstanceName="txt_chartcode" runat="server" Width="100%" ClientReadOnly="true"></dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                                <dx:LayoutItem Caption="" Paddings-PaddingTop="15" ParentContainerStyle-Paddings-PaddingLeft="2" ParentContainerStyle-Paddings-PaddingRight="2" Paddings-PaddingBottom="13">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <button type="button" id="PopUpchartid" title="بحث" data-name="chart" data-tablename="gl_chart_sel_pop" data-displayfields="chartcode,chartname" data-displayfieldscaption="كود الحساب,إسم الحساب"
                                            data-displayfieldshidden="chartid"data-bindcontrols="hf_accpaidid;txt_chartename;txt_chartcode" data-bindfields="chartid;chartname;chartcode"
                            ...
                            <dx:LayoutItem Caption="الحساب">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ID="txt_chartename" ClientInstanceName="txt_chartename" runat="server" Width="100%">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                                <dx:LayoutItem Caption="">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_save_exp" runat="server" AutoPostBack="False" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="حفظ" Height="20px" Width="20px" OnClick="btn_save_exp_Click">
                                                <ClientSideEvents Click="function(s, e) {validateexp(s, e);}" />
                                                <Image Height="20px" Url="~/Img/Icon/save.svg" Width="20px"></Image>
                                            </dx:ASPxButton>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_new_exp" runat="server" AutoPostBack="False" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="جديد" Height="20px" Width="20px">
                                                <ClientSideEvents Click="function(s, e) {Clear_exp();}"></ClientSideEvents>
                                                <Image Height="20px" Url="~/Img/Icon/add-new.svg" Width="20px"></Image>
                                            </dx:ASPxButton>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete_exp" runat="server" AutoPostBack="False" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="حذف" Height="20px" Width="20px">
                                                <ClientSideEvents Click="function(s, e) {getgvpayrow();delData_Detail('/VanSalesService/P_inv/DelExp', 'invpayid', 'hf_invexpid',gv_invpay)}" />
                                                <Image Height="20px" Url="~/Img/Icon/delete.svg" Width="20px"></Image>
                                            </dx:ASPxButton>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                ...
                <asp:HiddenField ID="hf_invexpid" runat="server" ClientIDMode="Static" />
                <dx:ASPxGridView ID="gv_p_invexp" runat="server" ClientInstanceName="gv_p_invexp" AutoGenerateColumns="False" EnableCallBacks="False" Width="100%" KeyFieldName="invpayid" Theme="MaterialCompact" RightToLeft="True" OnDataBinding="gv_pinvexp_DataBinding" ClientSideEvents-RowDblClick="function(s,e){gv_Bind_exp(s,e)}">
                    <Settings ShowFilterRow="True" ShowFilterRowMenu="True" ShowFooter="True" />
                    <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                    <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" />
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="invexpid" ReadOnly="True" VisibleIndex="0" Visible="false">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="expid" VisibleIndex="1" Visible="false">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="pinvid" VisibleIndex="2" Visible="false">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="expname" VisibleIndex="3" Caption="المصروف">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="expvalue" VisibleIndex="4" Caption="القيمه">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="accpaidid" VisibleIndex="5" Visible="false">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="chartcode" VisibleIndex="6" Caption="كود الحساب">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="chartname" VisibleIndex="7" Caption="إسم الحساب">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <SettingsAdaptivity AdaptivityMode="HideDataCells" AllowOnlyOneAdaptiveDetailExpanded="true" AllowHideDataCellsByColumnMinWidth="true"></SettingsAdaptivity>
                    <SettingsBehavior AllowEllipsisInText="true" />
                    ...
                    <TotalSummary>
                        <dx:ASPxSummaryItem FieldName="expvalue" ShowInColumn="القيمه" SummaryType="Sum" DisplayFormat=" {0}" />
                    </TotalSummary>
                      <Styles>
                            <Footer Font-Bold="True" Font-Size="Medium" ForeColor="#009933"></Footer>
                        </Styles>
            ...
            <asp:Panel ID="p_invpay" runat="server" BorderStyle="None" Font-Bold="True" Direction="RightToLeft" Style="text-align: right; display: none">
                        ...
                        <dx:LayoutGroup ColCount="6" GroupBoxDecoration="box" Caption="طرق الدفع" UseDefaultPaddings="false" Paddings-PaddingTop="10" CellStyle-Font-Bold="true">
                            ...
                            <Items>
                                <dx:LayoutItem Caption="طريقه الدفع">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox ID="cmb_paytypeid" runat="server" AutoPostBack="true" ClientInstanceName="cmb_paytypeid" Theme="MaterialCompact" RightToLeft="True"></dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_save_pay" runat="server" AutoPostBack="False" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="حفظ" Height="20px" Width="20px" OnClick="btn_save_pay_Click">
                                                <ClientSideEvents Click="function(s, e) {validatePay(s, e);}" />
                                                <Image Height="20px" Url="~/Img/Icon/save.svg" Width="20px"></Image>
                                            </dx:ASPxButton>
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_new_pay" runat="server" AutoPostBack="False" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="جديد" Height="20px" Width="20px">
                                            ...
                                            <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete_pay" runat="server" AutoPostBack="False" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="حذف" Height="20px" Width="20px">
                                                <ClientSideEvents Click="function(s, e) {getgvpayrow();delData_Detail('/VanSalesService/P_inv/DelPay', 'invpayid', 'Hf_invpayid',gv_invpay)}" />
                                                <Image Height="20px" Url="~/Img/Icon/delete.svg" Width="20px"></Image>
                                            </dx:ASPxButton>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                ...
                <dx:ASPxGridView ID="gv_invpay" runat="server" ClientInstanceName="gv_invpay" AutoGenerateColumns="False" EnableCallBacks="False" Width="100%" KeyFieldName="invpayid" Theme="MaterialCompact" RightToLeft="True" OnDataBinding="gv_invpay_DataBinding" OnDataBound="gv_invpay_DataBound" ClientSideEvents-RowDblClick="function(s,e){gv_Bind_Pay(s,e)}" OnCustomCallback="gv_invpay_CustomCallback">
                    <Settings ShowFilterRow="True" ShowFilterRowMenu="True" ShowFooter="True" />
                    <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                    <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" />
                    <Columns>
