<%@ Page Title="تقرير اجمالى اصناف المشتريات" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="total_p_inv_items.aspx.cs" Inherits="VanSales.Purchases.total_p_inv_items" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td class="text-center" style="background-color: #dcdcdc">
                    <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="تقرير اجمالى اصناف المشتريات" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                </td>
            </tr>
        </table>
    </div>
        ...
        <ContentTemplate>
                    ...
                    <dx:LayoutGroup ColCount="6" GroupBoxDecoration="Box" Caption="اعمده التقرير" Name="checkboxs" >
                        ...
                        <Items>
                            ...
                            <dx:LayoutItem Caption="">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox ID="chk_invQty" runat="server" Text="كميه المشتريات" AutoPostBack="true" OnCheckedChanged="chk_groupname_CheckedChanged" Checked="true" ClientInstanceName="chk_invQty"   ></dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox ID="chk_invvalue" runat="server" Text="اجمالى المشتريات" AutoPostBack="true" OnCheckedChanged="chk_groupname_CheckedChanged" Checked="true" ClientInstanceName="chk_invvalue"   ></dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
            ...
            <dx:ASPxGridView ID="gvs_inv_itms" ClientInstanceName="gvs_inv_itms" SettingsText-Title=" تقرير اجمالى مشتريات الاصناف" runat="server" AutoGenerateColumns="False" EnableCallBacks="False" KeyboardSupport="true" AccessKey=" " OnCustomSummaryCalculate="gvs_inv_itms_CustomSummaryCalculate"  OnDataBinding="gvs_inv_itms_DataBinding" Width="100%" KeyFieldName="invdtlid" Theme="MaterialCompact" RightToLeft="True" CssClass="grid">
                ...
                <Columns >
                    ...
                    <dx:GridViewDataTextColumn FieldName="invQty" VisibleIndex="4" Caption="كمية المشتريات"  PropertiesTextEdit-DisplayFormatString="#.00"  >
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="invvalue" VisibleIndex="5"  Caption="إجمالى المشتريات" PropertiesTextEdit-DisplayFormatString="{0:n2}" >
                    </dx:GridViewDataTextColumn>
                ...
                <GroupSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="invQty" SummaryType="Sum" DisplayFormat=" {0:n2}" ShowInGroupFooterColumn="كمية المشتريات"></dx:ASPxSummaryItem>
                    <dx:ASPxSummaryItem FieldName="invvalue" SummaryType="Sum" DisplayFormat=" {0:n2}" ShowInGroupFooterColumn="إجمالى المشتريات"></dx:ASPxSummaryItem>
