<%@ Page Title="مجموعات الموردين" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuppGroup.aspx.cs" Inherits="VanSales.Group.SuppGroup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="dx-justification" style="width: 100%">
        <tr>
            <td style="background-color: #dcdcdc;" class="text-center">
                
                <dx:ASPxLabel ID="lbltitle" runat="server" Text="مـجـمـوعـات الموردين" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
            ...
            <td style="text-align: center">
                ...
                <div class="col-md-12"  dir="rtl">
                     <dx:ASPxButton UseSubmitBehavior="false" ID="btn_addnew" runat="server" Height="20px" Width="20px" ToolTip="جديد" Image-Url="~/Img/Icon/add-new.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                        <ClientSideEvents Click="function(s, e) {gvsuppgroup.AddNewRow();}" />
                    </dx:ASPxButton>
                     ...
                     <dx:ASPxButton UseSubmitBehavior="false" ID="ASPxbtnexpandcollapse" runat="server" Height="20px" Width="20px" ToolTip="إظهار التفاصيل" Image-Url="~/Img/Icon/expand.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                        <ClientSideEvents Click="function(s, e) {if (this.ToolTip == &quot;اظهار الكل&quot;) {gvsuppgroup.CollapseAll();this.ToolTip = &quot;اخفاء الكل&quot;;}else {gvsuppgroup.ExpandAll();this.ToolTip = &quot;اظهار الكل&quot;;}}"></ClientSideEvents>
                    </dx:ASPxButton>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <dx:ASPxGridView ID="gvsuppgroup" ClientInstanceName="gvsuppgroup" runat="server" AutoGenerateColumns="False" RightToLeft="True" Width="100%" EnableTheming="True" Theme="MaterialCompact" ButtonRenderMode="Image" OnCustomCallback="gvsuppgroup_CustomCallback" KeyFieldName="pgrpid" OnRowInserting="gvsuppgroup_RowInserting" OnRowUpdating="gvsuppgroup_RowUpdating" OnDataBinding="gvsuppgroup_DataBinding">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="pgrpid" VisibleIndex="1" ReadOnly="True" Caption="كود المجموعة" PropertiesTextEdit-NullDisplayText="تلقائي" PropertiesTextEdit-NullText="تلقائي">
                            <EditFormSettings Visible="True"></EditFormSettings>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="pgrpname" VisibleIndex="2" Caption="إسم المجموعة">
                            <PropertiesTextEdit>
    ...
    <dx:ASPxGridViewExporter ID="gvsuppgroupExporter" runat="server" FileName="المجموعات" GridViewID="gvsuppgroup" PaperKind="A4" PaperName="Group"
        ...
        function deldata() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    gvsuppgroup.PerformCallback(null);
                } else if (
