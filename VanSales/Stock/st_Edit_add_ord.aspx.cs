...
{
    public partial class st_Edit_add_ord : EmaxBasepage
    {
        ...
        {
            pageid = "15";
           // ParamaterObject = new object[] { ddl_branchid };
            base.OnInit(e);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           // lbl_postst.Text = "";
            if (!IsPostBack)
            {
                ...
                Util.GenerateCombobox("sys_fillcomp_sel", ddl_naturetran, "compid,table_name", "7,sys_fillcomp", "citemid", "citemname");
                ...
                //    Lbl_Tittle.Text = "تحديث بيانات إذن إضافة";
                //}
                //else
                //{
                //    //Page.Title = "تسجيل إذن إضافة جديد";
                //    Lbl_Tittle.Text = "تسجيل إذن إضافة جديد";
                //}
            }
        ...
        List<object> GetParam()
        {
            ...
            {
                return new List<object> { txt_trandocno, ddl_branchid, txt_trannotes, ddl_naturetran, txt_username, ddl_ccid, txt_trandate, HF_transid };
            }
            else
            {
                return new List<object> { txt_trandocno, txt_trannotes, ddl_naturetran, txt_username, ddl_ccid, txt_trandate, HF_transid };
            }
        }
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            //Dictionary<object, object> dictupd = new Dictionary<object, object>();
            //dictupd.Add("transid", HF_transid.Value);
            var res = SaveData(EmaxGlobals.NullToIntZero( HF_transid.Value)==0?"st_transactions_ins": "st_transactions_upd"
          ,GetParam(), null,
        ...
        protected void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<object, object> dict = new Dictionary<object, object>();
            dict.Add("transid", HF_transid.Value);
            SqlCommandHelper.ExecuteNonQuery("st_transactions_del", dict,true);
            clear();
        }
        ...
        protected void btn_save_dtls_Click(object sender, EventArgs e)
        {
            ...
            var res = SaveData(EmaxGlobals.NullToIntZero(HF_transdtlid.Value) == 0 ? "st_transdtls_ins" : "st_transdtls_upd", _params, /*dictupd*/null,
                 null, true, true, null
                 , dictmaster);
            if (res.errorid == 0)
            {
        ...
        public static string Deletedatadtl(int transdtlid)
        {
          ...
          var res=  SqlCommandHelper.ExecuteNonQuery("st_transdtls_del", dict, true);
            return JsonConvert.SerializeObject(res);
        }
        protected void btn_delete_dtls_Click(object sender, EventArgs e)
        {
            ...
            SqlCommandHelper.ExecuteNonQuery("st_transdtls_del", dict,true);
            gvs_transdtls.DataBind();
            Clear_dtl();
           // HF_transdtlid.Value = "";
        }
        ...
        DataTable GvdetailSource()
        {
            ...
            return SqlCommandHelper.ExcecuteToDataTable("st_transdtls_sel", dict).dataTable;
        ...
        protected void txt_itemid_TextChanged(object sender, EventArgs e)
        {
            ...
            ///EmaxGlobals.NullToBool(HiddenField1.Value) ? false : true;
            //Dictionary<object, object> dict = new Dictionary<object, object>();
        ...
        protected void btn_xlsxexport_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              ExportingDevExpressUtil.Export(gvitemsExporter, "تفاصيل اذون الاضافه", 1, Request.GetOwinContext().Request.User.Identity.Name, gvs_transdtls.GetSelectedFieldValues("transdtlid").Count != 0, false,"تفاصيل اذن الاضافه رقم " + txt_transno.Text);
            }
            catch (Exception ex)
            {
        ...
        protected void btn_attach_Click(object sender, EventArgs e)
        {
            ...
            using (OleDbConnection excel_con = new OleDbConnection(conString))
            {
                ...
                var res = SaveData("st_trans_itemexcel_ins",new List<object> { HF_transid},null,
                null, true, true, null
                , null);
            if (res.errorid == 0)
            {
        ...
        protected void btn_print_Click(object sender, EventArgs e)
        {
            ...
            PrintPage("Stock/st_addtrans_page.repx", dict);
        }
    }
}