<%@ Page Title="مجموعات الأصناف" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemGroups.aspx.cs" Inherits="VanSales.Group.ItemGroups" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="dx-justification" style="width: 100%">
        <tr>
            <td style="background-color: #dcdcdc;" class="text-center">
                
                    <dx:ASPxLabel ID="lbltitle" runat="server" Text="مـجـمـوعـات الأصـنـاف" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
            ...
            <td style="text-align: center">
                ...
                <div class="col-md-12"  dir="rtl">
                     <dx:ASPxButton UseSubmitBehavior="false" ID="btn_addnew" runat="server" Height="20px" Width="20px" ToolTip="جديد" Image-Url="~/Img/Icon/add-new.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                        <ClientSideEvents Click="function(s, e) {gvgroup.AddNewRow();}" />
                    </dx:ASPxButton>
                     ...
                     <dx:ASPxButton UseSubmitBehavior="false" ID="ASPxbtnexpandcollapse" runat="server" Height="20px" Width="20px" ToolTip="إظهار التفاصيل" Image-Url="~/Img/Icon/expand.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
                        <ClientSideEvents Click="function(s, e) {if (this.ToolTip == &quot;اظهار الكل&quot;) {gvgroup.CollapseAll();this.ToolTip = &quot;اخفاء الكل&quot;;}else {gvgroup.ExpandAll();this.ToolTip = &quot;اظهار الكل&quot;;}}"></ClientSideEvents>
                    </dx:ASPxButton>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <dx:ASPxGridView ID="gvgroup" ClientInstanceName="gvgroup" runat="server" AutoGenerateColumns="False" RightToLeft="True" Width="100%" EnableTheming="True" Theme="MaterialCompact" ButtonRenderMode="Image" OnCustomCallback="gvgroup_CustomCallback" KeyFieldName="groupid" OnDataBinding="gvgroup_DataBinding" OnRowInserting="gvgroup_RowInserting" OnRowUpdating="gvgroup_RowUpdating">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="groupid" VisibleIndex="1" ReadOnly="True" Caption="كود المجموعة" PropertiesTextEdit-NullDisplayText="تلقائي" PropertiesTextEdit-NullText="تلقائي">
                            <EditFormSettings Visible="True"></EditFormSettings>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="groupname" VisibleIndex="2" Caption="إسم المجموعة">
                            <PropertiesTextEdit MaxLength="100">
                                <ValidationSettings Display="Dynamic" ErrorText="يجب ملئ هذا الحقل">
                                    <RequiredField IsRequired="True"></RequiredField>
                                </ValidationSettings>
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="groupnotes" VisibleIndex="3" Caption="ملاحظات">
            ...
            <EditForm Width="730">
                ...
                <%--<asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:VanSales %>' SelectCommand="st_group_sel" DeleteCommand="st_group_del" DeleteCommandType="StoredProcedure" InsertCommand="st_group_ins" InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure" UpdateCommand="st_group_upd" UpdateCommandType="StoredProcedure">
                    <DeleteParameters>
                        <asp:Parameter Name="groupid" Type="Int32"></asp:Parameter>
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="groupid" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="groupname" Type="String"></asp:Parameter>
                        <asp:Parameter Name="groupnotes" Type="String"></asp:Parameter>
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="groupid" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="groupname" Type="String"></asp:Parameter>
    ...
    <dx:ASPxGridViewExporter ID="gvgroupExporter" runat="server" FileName="المجموعات" GridViewID="gvgroup" PaperKind="A4" PaperName="Group"
