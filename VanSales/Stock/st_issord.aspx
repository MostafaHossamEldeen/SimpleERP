<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="st_issord.aspx.cs" Inherits="VanSales.Stock.st_issord" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="أذون الصرف" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div dir="rtl" style="text-align: center;" >
                    <dx:ASPxButton ID="btn_addnew" runat="server" Height="20px" Width="20px" ToolTip="جديد" Image-Url="~/Img/Icon/add-new.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary" OnClick="btn_new_Click">
                        <%--<ClientSideEvents Click="function(s, e) {gvitems.AddNewRow();}" />--%>
                    </dx:ASPxButton>
                    <dx:ASPxButton ID="btn_multidel" runat="server" Height="20px" Width="20px" ToolTip="حذف المحدد" Image-Url="~/Img/Icon/delete.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary" ClientSideEvents-Click="function (s,e){deldata()}">
                    </dx:ASPxButton>
                    <dx:ASPxButton ID="btn_xlsx_export" runat="server" Height="20px" Width="20px" ToolTip="Excel" Image-Url="~/Img/Icon/excel.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary" OnClick="btn_xlsx_export_Click">
                    </dx:ASPxButton>
                    <dx:ASPxButton ID="btn_doc_export" runat="server" Height="20px" Width="20px" ToolTip="Word" Image-Url="~/Img/Icon/word.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary" OnClick="btn_doc_export_Click"></dx:ASPxButton>
                    <dx:ASPxButton ID="btn_pdf_export" runat="server" Height="20px" Width="20px" ToolTip="PDF" Image-Url="~/Img/Icon/pdf.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary" OnClick="btn_pdf_export_Click"></dx:ASPxButton>
                    <dx:ASPxButton ID="btn_print_export" runat="server" Height="20px" Width="20px" ToolTip="طباعة" Image-Url="~/Img/Icon/print.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary" OnClick="btn_print_export_Click"></dx:ASPxButton>
                    <dx:ASPxButton ID="btn_expand_collapse" runat="server" Height="20px" Width="20px" ToolTip="إظهار التفاصيل" Image-Url="~/Img/Icon/expand.svg" AutoPostBack="False" Image-Width="20px" Image-Height="20px" RenderMode="Secondary">
    ...
    <dx:ASPxGridView ID="gv_issord" ClientInstanceName="gv_issord" runat="server" AutoGenerateColumns="False" KeyFieldName="transid" RightToLeft="True" Width="100%" EnableTheming="True" Theme="MaterialCompact" ButtonRenderMode="Image" OnDataBinding="gv_issord_DataBinding" OnCustomCallback="gv_issord_CustomCallback">
        ...
        <SettingsExport PaperKind="A4" FileName="أذون الصرف" PaperName="أذن الصرف" RightToLeft="True">
            <PageHeader>
        ...
        <dx:ASPxGridViewExporter ID="gv_issord_Exporter"  runat="server" FileName="أذون الصرف" GridViewID="gv_issord" PaperKind="A4" PaperName="أذون الصرف" RightToLeft="True" Landscape="True" >
        <PageHeader Center="أذون الصرف">
        </PageHeader>
        ...
        function deldata() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    gv_issord.PerformCallback(null);
                } else if (
