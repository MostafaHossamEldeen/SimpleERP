<%@ Page Title="أذون الاضافه" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="st_Edit_add_ord.aspx.cs" Inherits="VanSales.Stock.st_Edit_add_ord" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%--<uc1:PopUpControlSearch runat="server" ID="PopUpControlSearch" TableName="st_transactions_sel_search" DisplayFields="transno,branchname,trandate" DisplayFieldsHidden="ccname,branchid,trandocno,naturetran,naturename,ccid,trannotes,transid,postst,postacc,vochrid"
        DisplayFieldsCaption="كود الاذن,الفرع,التاريخ" BindControls="txt_transno;txt_trandocno;ddl_branchid;txt_trandate;ddl_naturetran;ddl_ccid;txt_trannotes;HF_transid;hf_postst;hf_postacc;txt_vochrid" BindFields="transno;trandocno;branchid;trandate;naturetran;ccid;trannotes;transid;postst;postacc;vochrid" ParamaterNames="hf_transtype" ApiUrl="/VanSalesService/Stock/AddOrderSearch"  PkField="transid" />--%>
...
<%--    <style>
    ...
    <%--<uc1:PopUpControlNormal runat="server" ID="Pop_items" TableName="st_itemunit_sel_pop" DisplayFields="itemcode,itemname,unitname" DisplayFieldsHidden="unitid,vat,factor,fprice,itemid,cprice"
        DisplayFieldsCaption="كود الصنف,اسم الصنف,الوحده,سعر التكلفه" BindControls="txt_itemid;txt_item_name;txt_unitname;HF_itemid;HF_unitid;HF_factor;HF_cost" BindFields="itemcode;itemname;unitname;itemid;unitid;factor;cprice" PkField="itemunitid" ApiUrl="/VanSalesService/items/FillPopup"   />--%>
    <script src="../Scripts/App/stock/add_ord.js"></script>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="text-center" style="background-color: #dcdcdc">
                            <dx:ASPxLabel ID="Lbl_Tittle" runat="server" Text="أذون الاضافه" Font-Bold="True" Font-Size="XX-Large" RightToLeft="True" Theme="MaterialCompact" ForeColor="#35B86B"></dx:ASPxLabel>
                        </td>
                    </tr>
                </table>
            </div>
...
e.processOnServer = confirm('هل تريد الحذف؟'); }" />
                 ...
                 <dx:ASPxButton UseSubmitBehavior="false" ID="btn_delete" runat="server" AutoPostBack="False" ClientInstanceName="btn_delete" Height="20px"  RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="حذف">
                       ...
                       <ClientSideEvents Click="function(s, e) {DelData_Master('/VanSalesService/Stock/addordDelMaster', 'HF_transid') }" />
                  <%--  <ClientSideEvents Click="function(s, e) {deldata('--https://localhost:44307/Stock/st_Edit_add_ord.aspx/Deletedata' ,'transid','HF_transid') }" />--%>
        ...
        data-BindFields="transno;trandocno;branchid;trandate;naturetran;ccid;trannotes;transid;postst;postacc;vochrno;username" data-ParamaterNames="hf_transtype"
        data-ApiUrl="/VanSalesService/Stock/AddOrderSearch"  data-PkField="transid"   onclick="createPopUp($(this),'popupModalsearch')" class="btn btn-sm btnsearchpopup"></button>
                 ...
                 <dx:ASPxButton  UseSubmitBehavior="false" ID="btn_postst" runat="server" ClientInstanceName="btn_postst"  AutoPostBack="False" Height="20px" RenderMode="Secondary" Theme="MaterialCompact" Width="20px" ToolTip="ترحيل مستودعات">
                    <ClientSideEvents Click="function(s,e){postAddOrderStock(s,e)}" />
...
print_newtab();
                            ...
                            <dx:LayoutItem Caption="رقم ألاذن">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox ValidationSettings-CausesValidation="true" ID="txt_transno" runat="server" ClientInstanceName="txt_transno" Theme="MaterialCompact" Font-Bold="True" ForeColor="Black" Text="تلقائى">
	 ...
	 preventwrite(s, e)
                            ...
                            <dx:LayoutItem Caption="نوع الأضافه">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
            ...
            <div dir="rtl">
                <asp:Panel ID="PDetiles" runat="server" BorderStyle="None" Font-Bold="True" Direction="RightToLeft" Style="display: none; text-align: right" ClientIDMode="Static">
                    <dx:ASPxFormLayout SettingsItemCaptions-Location="Top" runat="server" ID="ASPxFormLayout1" CssClass="formLayout" RightToLeft="True">
                        <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="900" />
                        <Items>
                            <dx:LayoutGroup ColCount="11" GroupBoxDecoration="box" Caption="تفاصيل أذن الاضافه" UseDefaultPaddings="false" CellStyle-Font-Bold="true">
                                    ...
                                    <dx:LayoutItem Caption="كود الصنف">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                ...
                                                <dx:ASPxTextBox ID="txt_itemid" runat="server" Theme="MaterialCompact" AutoPostBack="false" ClientInstanceName="txt_itemid" TabIndex="0" >
	...
	txt_unitname.GetInputElement().readOnly = true; 
                                    ...
                                    <dx:LayoutItem Caption="" ColumnSpan="3" Paddings-PaddingTop="11">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                 ...
                                                 <dx:ASPxButton UseSubmitBehavior="false" ID="btn_save_dtls" runat="server" AutoPostBack="False" ClientInstanceName="btn_save_dtls" RenderMode="Secondary" Theme="MaterialCompact" ToolTip="حفظ" Height="20px" Width="20px" OnClick="btn_save_dtls_Click" TabIndex="3">
	 ...
	 clear_item();
                                       ...
                                       e.processOnServer = confirm('هل تريد الحذف؟');}" />
                                                    ...
                                                    <%--<ClientSideEvents Click="function(s, e) {getgvrow(); delData_Dtl('/Stock/st_Edit_add_ord.aspx/Deletedatadtl' ,'transdtlid','HF_transdtlid',gvs_transdtls) }" />--%>
                                                        <ClientSideEvents Click="function(s, e) {getgvrow();delData_Detail('/VanSalesService/Stock/gAddordDtl', 'transdtlid', 'HF_transdtlid',gvs_transdtls) }" />
                                                    <Image Height="20px" Url="~/Img/Icon/delete.svg" Width="20px"></Image>
                                                </dx:ASPxButton>
    ...
    <div class="modal-dialog" role="alertdialog" style="width:100%">
     ...
     <div class="custgroup">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <br />
                               <button type="button" id="PopUpchartid" style=" z-index:9999999999; position:fixed;" title="بحث" data-name="chart" data-tablename="gl_chart_sel_pop" data-displayfields="chartcode,chartname" data-displayfieldscaption="كود الحساب,إسم الحساب"
        ...
        <div>
            <button type="button" class="btn btn-sm addcustpopup " onclick="postAddOrderAcc()" >
