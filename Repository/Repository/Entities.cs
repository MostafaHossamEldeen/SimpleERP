...
namespace EMax.Dal.Repository
{
    public class Entities<TEntity> : IDisposable, IEntities<TEntity> where TEntity : class
    {

        #region Field
        public Expression<Func<TEntity, bool>> Filter { get; set; }

        protected UnitOfWork DbContext;
        ...
        public Entities(UnitOfWork context)
        {
            DbContext = context;
        }
        #endregion
        ...
        public bool IsExcist(Expression<Func<TEntity, bool>> match)
        {
            return DbContext.Set<TEntity>().SingleOrDefault(match)!=null;
        }
