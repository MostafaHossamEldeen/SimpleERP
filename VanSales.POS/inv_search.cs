...
{
    public partial class inv_search : DevExpress.XtraEditors.XtraForm
    {
        public inv_search()
        {
            InitializeComponent();
        ...
        private void inv_search_Load(object sender, EventArgs e)
        {
        ...
        private void inv_search_KeyDown(object sender, KeyEventArgs e)
        {
            txt_search.Focus();
